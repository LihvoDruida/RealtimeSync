...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate Fabric/Quilt Loom configuration for the Minecraft 1.21.x branch.")
...
def main() -> int:
    ...
    for rel in ("fabric/build.gradle", "quilt/build.gradle"):
        ...
        forbidden = (
            "isMinecraft26Plus",
            "apply plugin: isMinecraft26Plus",
            'implementation "net.fabricmc:fabric-loader',
            'implementation "net.fabricmc.fabric-api:fabric-api',
        )
